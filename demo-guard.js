...
/* Re-applies the diagonal "vgartg.ru" watermark if anyone tries to disable it
   via DevTools (override !important rules, remove the stylesheet, edit inline
   styles on html/body, etc.). Pairs with the CSS block in the main stylesheet.
   Remove with the `demo-watermark-remove` skill. */
(function () {
